...
def match_orb_knn(img1_gray: np.ndarray, img2_gray: np.ndarray, nfeatures=1000, ratio=0.7):
...
def match_sift_flann_ransac(img1_gray: np.ndarray, img2_gray: np.ndarray, ratio=0.7, ransacReproj=3.0):
...
def eval_pair(img1_path: str, img2_path: str, outdir: str, pair_name: str,
              orb_thresh: int = 20, sift_thresh: int = 12):
